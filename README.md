...
![output](Product%20&%20Demo-Jiaojiao%27s%20part/output.gif)or if you want to detect all the things, not just people, then you can use people_counting_at_cashier1.py instead of people_counting_at_cashier.py, see the results in output1.pm4

```python
python3 people_counting_at_cashier1.py --input input_video.mp4
```
![output1](../Desktop/Courses-4th%20semester%E7%AC%AC%E5%9B%9B%E5%AD%A6%E6%9C%9F/Software%20Technology/VigilHeat-project/src/output1.gif)
...
![image-20230430223044199](Product%20&%20Demo-Jiaojiao%27s%20part/image-20230430223044199.png)
