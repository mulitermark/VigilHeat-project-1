...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--skip-frames", type=int, default=10, help="Number of frames to skip (default is 10)")
...
def main():
    ...
    while True:
        ...
        cv2.putText(frame,str(datetime.datetime.now().strftime('%Y-%m-%d %H:%M:%S')),(10, 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
